...
I enjoyed the breakdown in the review video where Kent explains that we need 3 things for this to work: the React library to manage the React elements (which may not necessarily be displayed in a web browser), the React DOM library (to convert React elements to DOM elements -- in this case, we DO want to display our React elements in the browser), and Babel to convert JSX to native JS (for creating React elements with terser JSX syntax)
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=03%3A%20Using%20JSX&em=ianjmacintosh%40gmail.com).
